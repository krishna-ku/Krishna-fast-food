...
public class RestaurantAppApplication {
	...
	public static void main(String[] args) throws IOException {
		...
		pdfText.addSingleLineText("Customer Name: "+name, 25, pageHeight-250, font, 16, Color.black);
		pdfText.addSingleLineText("Mo. No: "+callNo, 25, pageHeight-274, font, 16, Color.black);
		
		String orderID="OrderId: 1";
		float textWidth=pdfText.getTextWidth(orderID,font,16);
		pdfText.addSingleLineText(orderID,(int)(pageWidth-25-textWidth), pageHeight-250, font,16, Color.black);
		
		float dateTextWidth=pdfText.getTextWidth("Date: "+dateFormat.format(new Date()),font, 16);
		pdfText.addSingleLineText("Date: "+dateFormat.format(new Date()),(int) (pageWidth-25-dateTextWidth), pageHeight-274, font, 16, Color.black);
		
		String time=timeFormat.format(new Date());
		float timeTextWidth=pdfText.getTextWidth("Time: "+timeFormat.format(new Date()),font, 16);
		pdfText.addSingleLineText("Time: "+timeFormat.format(new Date()),(int) (pageWidth-25-timeTextWidth), pageHeight-298, font, 16, Color.black);
		
		
		PdfTable table=new PdfTable(document, contentStream);
		...
		pdfText.addSingleLineText(bottomLine,(int)((pageWidth-bottomLineWidth)/2), 50, italicFont, 20, Color.DARK_GRAY);
