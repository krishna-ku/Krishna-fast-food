...
public class MenuCategoryController {
	...
	public ResponseEntity<MenuCategoryDTO> updateMenuCategory(@RequestBody MenuCategoryDTO menuCategoryDTO,
	...
	/**
	 * Delete menuCategory by id Method : DELETE Service url: /menucategories/id
	 * method : DELETE
	 * 
	 * @param id
	 * 
	...
	public ResponseEntity<List<MenuCategoryDTO>> getAllMenuCategories(
		...
		List<MenuCategoryDTO> menusCategories = menuCategoryService.getAllMenusCategories(pageNumber, pageSize);
